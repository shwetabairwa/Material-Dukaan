  ...
  return (
    ...
    >
      ...
      <div style={styles.info}>
        ...
        <p style={styles.subtitle}>{description?.shortDesc}</p>
        ...
        <div style={styles.priceRow}>
          <span style={styles.price}>${salePrice.toFixed(0)}</span>
          ...
          {quantity === 0 ? (
            ...
            <div style={styles.quantityBox} onClick={(e) => e.stopPropagation()}>
              <button style={styles.qtyBtn} onClick={(e) => onDecrement(e, product.rowId)}>−</button>
              <span style={styles.qtyText}>{quantity}</span>
              <button style={styles.qtyBtn} onClick={(e) => onIncrement(e, product.rowId)}>+</button>
            </div>
          )}
        </div>
      </div>
